...
/*   Updated: 2025/03/18 20:57:22 by stliu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
remove char c of string s1 if found in the set from front and back
malloc for the new string size

Return: new string that is trimmed of set characters. s1 stays original
*/
