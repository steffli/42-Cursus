...
/*   Updated: 2025/03/19 14:39:25 by stliu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
Input: string s and char c
introduce helper functions to handle the counting of words, 
returning the words with proper allocation of memory, creating 
matrix with allocation for the number of words and 
a function that frees the matrix if the allocation fails

Return: matrix with the split strings as each element
*/
